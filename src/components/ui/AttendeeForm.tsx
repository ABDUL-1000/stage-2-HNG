...
console.log(formData)
  ...
  return (
    <div className="lg:w-[40%] w-[40%] bg-navBar lg:border-[0.01rem] border-border mt-20 rounded-3xl p-1 lg:p-10">
      <div className="gap lg:gap-4 w-full bg-navBarr rounded-3xl max-w-4xl">
        <div className="relative border-b-[0.01rem] border-border pl-1 flex flex-row justify-between items-center">
          <h1 className="font-jejun text-white text-[0.6rem] lg:text-sm tracking-wide pb-2">Attendee Details</h1>
        ...
        <div className="lg:bg-[#08252B] rounded-3xl flex flex-col items-center lg:border-border lg:border-[0.01rem] mt-5 p-2">
          <p className="text-white text-[0.6rem] lg:text-sm">Upload your picture</p>
          ...
          <form onSubmit={handleSubmit} className="w-full space-y-1">
            <div className="mt-2 w-full">
              <label className="block text-[0.6rem] lg:text-sm p-2 text-white">Enter your name</label>
              <input
                type="text"
                value={formData.name}
            ...
            <div>
              <label className="block text-[0.6rem] lg:text-sm p-2 text-white">Enter your email *</label>
              <input
                type="email"
            ...
            <div>
              <label className="block text-[0.6rem] lg:text-sm p-2 text-white">About the project</label>
              <textarea className="w-full p-[0.2rem] lg:p-2 border rounded-lg bg-navBar text-white"  placeholder="Textarea" 
            ...
            <div className="flex flex-col lg:flex-row-reverse justify-center lg:gap-2 space-y-4 lg:space-y-0">
              ...
              <button type="submit" className="p-1 rounded w-full bg-[#24A0B5] text-white text-[0.6rem] lg:text-[0.5rem]">
                Get My Free Ticket
              </button>
              </Link>
                <Link href="/" className="w-full">
              <button type="button" className="p-1 rounded w-full text-white text-[0.6rem] lg:text-[0.6rem] bg-navBar border-[0.01rem] border-border">
                Back
              </button>
              </Link>
            </div>
