    ...
    <div className="lg:w-[50%] w-[50%] flex items-center bg-navBar lg:border-[0.01rem] border-border  rounded-3xl p-1 lg:p-10 ">
      <div className="   lg:gap-4 w-full max-w-4xl">
        <div className="relative border-b-[0.01rem] border-border block lg:flex lg:flex-row justify-between  items-center lg:border-b-[0.01rem] lg:border-border">
          <h1 className="relative font-jejun text-white text-[0.6rem]   tracking-wide pb-2  before:absolute before:bottom-[-3px] before:left-0 before:w-full before:h-[4px] lg:before:bg-border1">
            Ticket Selection
          </h1>
          ...
          <div className=" flex flex-col space-y-10 bg-[#08252B] rounded-lg mt-7 items-center gap-2 p-4 border-border">
            <div className="border-border space-y-5 bg-gradient-to-r  from-[#0E464F] to-[#08252B] border-[0.01rem] w-full rounded-lg p-4  flex flex-col items-center">
              <div className=" flex flex-col items-center lg:gap-3 ">
                <h1 className={`text-white ${roadRage.className} lg:text-[62px]  text-sm   font-bold`}>
                  Techember Fest ”25
                </h1>
        ...
        <h1 className="relative font-jejun text-white text-sm lg:text-2xl pt-3 lg:pt-5">Select Ticket Type:</h1>
        <div className="flex flex-col lg:grid lg:grid-cols-3 bg-[#08252B]  rounded-lg mt-2 items-center gap-2 p-4">
          {[
            ...
            <div
              ...
              className={`flex w-full flex-col gap-2 p-2 justify-between hover:bg-[#2C545B]  cursor-pointer rounded-lg border-[0.01rem] ${ticketType === ticket.name ? "border-[#2BA4B9] bg-[#197686]" : "border-[#0E464F] bg-[#08252B]"}`}
              onClick={() => handleTicketTypeChange(ticket.name)}
            >
               <p className="font-roboto text-white font-semibold text-[1rem] lg:text-[1.2rem] ">{ticket.price}</p>
              <div className="flex flex-col items-start">
                <p className="text-white text-[0.8rem] lg:text-[0.8rem] font-roboto">{ticket.name}</p>
        ...
        <h1 className="relative font-jejun text-white text-sm lg:text-2xl pt-5">Number of Tickets:</h1>
        <div className="flex flex-col bg-[#08252B] rounded mt-2 items-center border-border">
          ...
          >
            {[1, 2, 3, 4, 5].map((num) => (
              <option key={num} value={num} className="text-[0.5rem] lg:text-xl">
                {num} Ticket{num > 1 ? "s" : ""}
              </option>
            ))}
          </select>
        ...
        <div className="lg:flex hidden flex-col w-full p-4 items-center">
          <div className="flex flex-row w-full justify-center items-center space-x-10">
            <Button className="bg-deepDark w-[50%]  hover:bg-deepDark2 text-[#24A0B5] border-[0.01rem] border-[#24A0B5]">Cancel</Button>
        ...
        <div className="flex lg:hidden flex-col mt-2 justify-center items-center gap-2 ">
          <Button className="bg-deepDark w-full  hover:bg-deepDark2 text-[#24A0B5] border-[0.01rem] border-[#24A0B5]">Cancel</Button>
