...
const MobileNavbar = () => {
  ...
  return (
    <div className="lg:hidden p-1">
      {/* Centered Navbar */}
      <div
        className="  w-[100%] max-w-[400px]  bg-navBar shadow-sm border-border border-[0.01rem] 
      ...
      <div
        className={`fixed top-0 left-0 h-screen w-64 bg-[#08252B] border-r-2 border-[#2BA4B9] 
                      p-5 transform ${
      ...
      >
        ...
        <div className="flex flex-col space-y-4">
          <a href="#" className="text-white text-lg font-jejun">
            Event
          </a>
          <a href="#" className="text-white text-lg font-jejun">
            My Tickets
