  ...
  return (
    <div className="hidden  lg:block">
      <div className="flex justify-center">
        <nav
          className=" mx-auto w-[80%] lg:w-[80%] bg-navBar shadow-sm rounded-2xl border-border border-[0.01rem] 
        ...
        >
          <div className="flex items-center justify-between ">
            ...
            <div className="flex items-center space-x-6">
              <Link href="/AttendeeForm" className="text-white font-jejun">
                Event
              </Link>
              <Link href="/TicketsDisplay" className="text-white font-jejun">
                Attendees
              </Link>
              <a href="#" className="text-white font-jejun">
                About Project
              </a>
            </div>
